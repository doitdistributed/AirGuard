...
class SafeDevicesFragment : DevicesFragment(showDevicesFound = false, showAllDevices = true, showSafeDevices = true) {
    override val deviceItemListener: DeviceAdapter.OnClickListener
        get() = DeviceAdapter.OnClickListener { baseDevice: BaseDevice, materialCardView: MaterialCardView ->
            ...
            val directions: NavDirections =
                SafeDevicesFragmentDirections
                    .actionNavigationSafeDevicesFragmentToTrackingFragment(
                        baseDevice.address
                    )
